	...
	return (
		<header className="bg-white shadow">
			<div className="container mx-auto px-4 py-4 flex items-center justify-between">
				...
				<div className="flex ">
					<Button variant={"default"} className="mr-4" onClick={() => setModalOpen(true)} >
						投稿
					</Button>
            ...
            {modalOpen && (
                ...
                className="fixed inset-0 bg-gray-950/30 flex items-center justify-center z-10"
                 ...
                 >
                  <Button className="font-black px-4 py-2 text-black bg-white rounded-lg hover:bg-gray-400 transition w-[240px] h-[280px]  z-20"
                  style={{ boxShadow: "0 4px 20px rgba(255,255,255,0.5"}}
                  onClick={(e) => {console.log("プロジェクト作成画面")}}
                  >
                        <div>
                            <p>プロジェクトを作成</p>
