    ...
    <div className="max-w-sm mx-auto mt-10">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
        <div>
          ...
          />
          {errors.name && (
            <p className="text-xs text-red-500 mt-1">{errors.name.message as React.ReactNode}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.confirmPassword && (
            <p className="text-xs text-red-500 mt-1">{errors.confirmPassword.message as React.ReactNode}</p>
          )}
        </div>
